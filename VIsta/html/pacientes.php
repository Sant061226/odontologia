...
<body>
    <div id="contenedor">
            ...
            <table>
                ...
                <?php while ($paciente = $result->fetch_object()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="" onclick="mostrarModalPac('<?php echo htmlspecialchars($paciente->PacIdentificacion); ?>','<?php echo htmlspecialchars($paciente->PacNombres); ?>','<?php echo htmlspecialchars($paciente->PacApellidos); ?>','<?php echo htmlspecialchars($paciente->PacFechaNacimiento); ?>','<?php echo htmlspecialchars($paciente->PacSexo); ?>');return false;">Editar</a>
        ...
        <div id="frmEdPaciente" title="Editar Paciente">
